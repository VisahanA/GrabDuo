...
"[project]/src/app/cart/CartModal.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CartModal({ isOpen, onClose }) {
    const { items, totalItems, totalPrice, updateQuantity, removeItem, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$cart$2f$CartContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-4",
                    children: items.length === 0 ? /* Empty Cart */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/src/app/services/ocrService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$badge$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/badge.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$cart$2f$CartContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/cart/CartContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$cart$2f$CartModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/cart/CartModal.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$ocrService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/services/ocrService.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function GroceryPage() {
    const { addItem, totalItems, items, updateQuantity, removeItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$cart$2f$CartContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const [isShoppingListModalOpen, setIsShoppingListModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const parseShoppingListFromText = (text)=>{
        ...
        let cleanedText = text.replace(/^\[|\]$/g, '') // Remove outer brackets
        ...
        for (const line of lines){
            ...
            if (line.includes(',') || line.includes(';') || line.includes(' and ')) {
                ...
                const splitItems = line.split(/[,;]|\s+and\s+/i).map((item)=>item.trim()).filter((item)=>item.length > 0);
        ...
        if (rawItems.length === 0 || rawItems.length === 1 && rawItems[0].length > 100) {
            const singleLineItems = cleanedText.split(/[,;]|\s+and\s+/i).map((item)=>item.trim()).filter((item)=>item.length > 0);
        ...
        if (rawItems.length === 0 || rawItems.length === 1 && !rawItems[0].includes(',') && !rawItems[0].includes(';')) {
            ...
            const spaceItems = cleanedText.split(/\s+/).map((item)=>item.trim()).filter((item)=>item.length > 1);
        ...
        for (const rawItem of rawItems){
            ...
            let cleanItem = rawItem.replace(/^[-*•]\s*/, '') // Remove bullet points
            ...
            if (cleanItem.length > 1 && cleanItem.length < 50) {
                ...
                if (!lowerItem.includes('shopping') && !lowerItem.includes('list') && !lowerItem.includes('grocery') && !lowerItem.includes('store') && !lowerItem.includes('market') && !lowerItem.includes('buy') && !lowerItem.includes('need') && !lowerItem.includes('get') && !lowerItem.includes('item') && !lowerItem.match(/^\d+$/) && // Just numbers
        ...
        const uniqueItems = items.filter((item, index)=>items.findIndex((i)=>i.toLowerCase() === item.toLowerCase()) === index);
    ...
    const handleSnapIt = async ()=>{
        ...
        fileInput.onchange = async (event)=>{
            ...
            try {
                // Check if OCR API is available
                const apiAvailable = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$ocrService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OCRService"].isAvailable();
                if (!apiAvailable) {
                    throw new Error('OCR service is not available. Please make sure the OCR API is running on localhost:8000');
                }
                // Process image with OCR
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$ocrService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OCRService"].extractTextFromImage(file);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: `px-2 py-1 text-xs font-medium rounded-full ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$badge$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBadgeStyles"])(product.badge)}`,
            ...
            isShoppingListModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d38eb35._.js.map